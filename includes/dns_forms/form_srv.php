        ...
        <input type="text" name="prio" id="prio" class="form-control" required autofocus="" value="<?php echo get_form_input_value('prio',10);?>">
        </div>
        <div class="form-group">
        <label for="port">Port</label>
        <input type="text" name="port" id="port" class="form-control" required autofocus="" value="<?php echo get_form_input_value('port');?>">
        </div>
        <div class="form-group">
        <label for="weight">Relative weight</label>
        <input type="text" name="weight" id="weight" class="form-control" required autofocus="" value="<?php echo get_form_input_value('weight');?>">
        </div>
        <div class="form-group">
